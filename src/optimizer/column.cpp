...
// Column
//===--------------------------------------------------------------------===//
Column::Column(ColumnID id, type::Type::Type::TypeId type, int size, std::string name,
               bool inlined)
    : id(id), type(type), size(size), name(name), inlined(inlined) {}

ColumnID Column::ID() const { return id; }

type::Type::Type::TypeId Column::Type() const { return type; }
...
// TableColumn
//===--------------------------------------------------------------------===//
TableColumn::TableColumn(ColumnID id, type::Type::Type::TypeId type, int size,
...
// ExprColumn
//===--------------------------------------------------------------------===//
ExprColumn::ExprColumn(ColumnID id, type::Type::Type::TypeId type, int size,
