...
storage::TileGroup *DataTable::TransformTileGroup22(
  ...
  LOG_DEBUG("Transforming tile group : %u", tile_group_offset);
  ...
  if(tile_group->GetHeader()->IsEvictable())

      new_tile_group->GetHeader()->SetEvictable(true);
